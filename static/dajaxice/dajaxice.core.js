...
var Dajaxice = {
    ...
    request_points: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.request_points', 'POST', callback_function, argv, custom_settings);
    },

    pagination: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.pagination', 'POST', callback_function, argv, custom_settings);
    },

    updatecombo: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.updatecombo', 'POST', callback_function, argv, custom_settings);
    },

    flickr_save: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.flickr_save', 'POST', callback_function, argv, custom_settings);
    },

    dajaxice_example: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.dajaxice_example', 'POST', callback_function, argv, custom_settings);
    },

    send_form: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.send_form', 'POST', callback_function, argv, custom_settings);
    },

    args_example: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.args_example', 'POST', callback_function, argv, custom_settings);
    },

    multiply: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.multiply', 'POST', callback_function, argv, custom_settings);
    },

    randomize: function(callback_function, argv, custom_settings){
        Dajaxice.call('register.randomize', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    call: function(dajaxice_function, method, dajaxice_callback, argv, custom_settings)
    {
        ...
        $.post( '/dajaxice/'+dajaxice_function+'/', { argv: JSON.stringify(argv) }, function(response){
				dajaxice_callback(response);
			}, "json" )
			.fail(function() {
				error_callback();
