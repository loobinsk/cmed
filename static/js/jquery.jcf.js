...
jcf.lib = {
	...
	hasClass: function (obj,cname) {
		return obj ? (obj.className ? obj.className.match(new RegExp('(\\s|^)'+cname+'(\\s|$)')) : false) : false;
	},
...
jcf.addModule({
	...
	refreshSelectedText: function() {
		if(!this.dropOpened && this.realElement.title) {
			...
			if(this.realElement.options[this.realElement.selectedIndex] && this.realElement.options[this.realElement.selectedIndex].title) {
