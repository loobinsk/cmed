...
class QuizTake(FormView):
    ...
    def form_valid_user(self, form):
        ...
        if is_correct is True:
            ...
            progress.update_score(self.sitting.progress()[0]+1, 1)
        else:
            self.sitting.add_incorrect_question(self.question)
            progress.update_score(self.sitting.progress()[0]+1, 0)
        ...
        progress.update_overallscore(self.sitting.get_percent_correct)
        progress.update_user_answers(self.question, guess)
