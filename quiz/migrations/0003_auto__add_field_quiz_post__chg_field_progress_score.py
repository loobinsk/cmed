...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quiz.post'
        db.add_column(u'quiz_quiz', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medtus.Translation'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Progress.score'
        db.alter_column(u'quiz_progress', 'score', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'Quiz.post'
        db.delete_column(u'quiz_quiz', 'post_id')


        # Changing field 'Progress.score'
        db.alter_column(u'quiz_progress', 'score', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=1024))
