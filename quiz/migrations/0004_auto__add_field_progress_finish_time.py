...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Progress.finish_time'
        db.add_column(u'quiz_progress', 'finish_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Progress.finish_time'
        db.delete_column(u'quiz_progress', 'finish_time')
