...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupUsers.invite'
        db.add_column(u'GroupUsers', 'invite',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['account.MyUser'], null=True, on_delete=models.DO_NOTHING, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupUsers.invite'
        db.delete_column(u'GroupUsers', 'invite_id')
    ...
    models = {
        ...
        u'groups.groupusers': {
            ...
            'invite': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['account.MyUser']", 'null': 'True', 'on_delete': 'models.DO_NOTHING', 'blank': 'True'}),
