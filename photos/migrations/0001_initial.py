...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PGalleries'
        db.create_table('PGalleries', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', db_column='user_id', to=orm['account.MyUser'])),
            ...
            ('image', self.gf('django.db.models.fields.CharField')(max_length=255, db_column='image', blank=True)),
            ('premoder', self.gf('django.db.models.fields.BooleanField')(db_column='premoder')),
            ('status', self.gf('django.db.models.fields.BooleanField')(db_column='status')),
            ('createdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_column='createdate', blank=True)),
            ('public_main', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'photos', ['PGalleries'])

        # Adding model 'PGPhotos'
        db.create_table('PGPhotos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.PGalleries'], db_column='pgallery_id')),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.MyUser'], null=True, db_column='user_id', blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255, db_column='title')),
            ('description', self.gf('django.db.models.fields.TextField')(db_column='description')),
            ('image', self.gf('django.db.models.fields.files.FileField')(max_length=100, db_column='image', blank=True)),
            ('status', self.gf('django.db.models.fields.BooleanField')(db_column='status')),
            ('createdate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_column='createdate', blank=True)),
            ('updatedate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, db_column='updatedate', blank=True)),
            ('comment_cnt', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='comment_cnt')),
            ('rating', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='rating')),
            ('votes', self.gf('django.db.models.fields.IntegerField')(default=0, db_column='votes')),
        ))
        db.send_create_signal(u'photos', ['PGPhotos'])


    def backwards(self, orm):
        # Deleting model 'PGalleries'
        db.delete_table('PGalleries')

        # Deleting model 'PGPhotos'
        db.delete_table('PGPhotos')
