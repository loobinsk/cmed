...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comments.safe'
        db.add_column(u'Comments', 'safe',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comments.safe'
        db.delete_column(u'Comments', 'safe')
    ...
    models = {
        ...
        u'comments.comments': {
            ...
            'content_type_id': ('django.db.models.fields.IntegerField', [], {'default': '47', 'null': 'True', 'blank': 'True'}),
