...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Posts', (
            ...
            ('anons', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('format', self.gf('django.db.models.fields.IntegerField')(blank=True)),
