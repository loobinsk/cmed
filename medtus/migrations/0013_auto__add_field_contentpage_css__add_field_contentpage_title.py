...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContentPage.css'
        db.add_column(u'medtus_contentpage', 'css',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ContentPage.title'
        db.add_column(u'medtus_contentpage', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContentPage.css'
        db.delete_column(u'medtus_contentpage', 'css')

        # Deleting field 'ContentPage.title'
        db.delete_column(u'medtus_contentpage', 'title')
