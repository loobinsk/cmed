...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Towns', fields ['country_id', 'region', 'name']
        db.create_unique(u'Towns', ['country_id', 'region', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Towns', fields ['country_id', 'region', 'name']
        db.delete_unique(u'Towns', ['country_id', 'region', 'name'])
