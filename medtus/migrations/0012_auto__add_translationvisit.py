...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TranslationVisit'
        db.create_table(u'medtus_translationvisit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dt_create', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('dt_update', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.MyUser'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medtus.Translation'])),
        ))
        db.send_create_signal(u'medtus', ['TranslationVisit'])


    def backwards(self, orm):
        # Deleting model 'TranslationVisit'
        db.delete_table(u'medtus_translationvisit')
