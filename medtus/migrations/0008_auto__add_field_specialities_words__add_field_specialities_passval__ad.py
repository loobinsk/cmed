...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Specialities.words'
        db.add_column(u'Specialities', 'words',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Specialities.passval'
        db.add_column(u'Specialities', 'passval',
                      self.gf('django.db.models.fields.IntegerField')(default=30),
                      keep_default=False)

        # Adding field 'Specialities.show'
        db.add_column(u'Specialities', 'show',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'MaterialPhoto.picture'
        db.alter_column(u'medtus_materialphoto', 'picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'MaterialPhoto.thumb'
        db.alter_column(u'medtus_materialphoto', 'thumb', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
        # Adding field 'Visited.lastview'
        db.add_column(u'medtus_visited', 'lastview',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=None, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Specialities.words'
        db.delete_column(u'Specialities', 'words')

        # Deleting field 'Specialities.passval'
        db.delete_column(u'Specialities', 'passval')

        # Deleting field 'Specialities.show'
        db.delete_column(u'Specialities', 'show')


        # Changing field 'MaterialPhoto.picture'
        db.alter_column(u'medtus_materialphoto', 'picture', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'MaterialPhoto.thumb'
        db.alter_column(u'medtus_materialphoto', 'thumb', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Deleting field 'Visited.lastview'
        db.delete_column(u'medtus_visited', 'lastview')
