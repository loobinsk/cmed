...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Translation.data'
        db.alter_column(u'medtus_translation', 'data', self.gf('tinymce.models.HTMLField')())
        # Adding index on 'Towns', fields ['checked']
        db.create_index(u'Towns', ['checked'])

        # Adding index on 'Towns', fields ['region']
        db.create_index(u'Towns', ['region'])

        # Adding index on 'Towns', fields ['country_id']
        db.create_index(u'Towns', ['country_id'])


    def backwards(self, orm):
        # Removing index on 'Towns', fields ['country_id']
        db.delete_index(u'Towns', ['country_id'])

        # Removing index on 'Towns', fields ['region']
        db.delete_index(u'Towns', ['region'])

        # Removing index on 'Towns', fields ['checked']
        db.delete_index(u'Towns', ['checked'])


        # Changing field 'Translation.data'
        db.alter_column(u'medtus_translation', 'data', self.gf('django.db.models.fields.TextField')())
