...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'medtus_translation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=u'\u0422\u0440\u0430\u043d\u0441\u043b\u044f\u0446\u0438\u044f', max_length=255)),
            ('data', self.gf('django.db.models.fields.TextField')(default=None, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'medtus', ['Translation'])


    def backwards(self, orm):
        # Deleting model 'Translation'
        db.delete_table(u'medtus_translation')
