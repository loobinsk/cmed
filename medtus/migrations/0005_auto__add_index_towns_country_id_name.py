...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Towns', fields ['country_id', 'name']
        db.create_index(u'Towns', ['country_id', 'name'])


    def backwards(self, orm):
        # Removing index on 'Towns', fields ['country_id', 'name']
        db.delete_index(u'Towns', ['country_id', 'name'])
