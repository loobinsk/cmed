...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'banners', ['URL'])

        # Adding model 'BannerGroup'
        db.create_table(u'banners_bannergroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'banners', ['BannerGroup'])
        ...
        db.create_table(u'banners_banner', (
            ...
            ('sort', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=500)),
            ...
            ('onlyauth', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('public', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        ...
        m2m_table_name = db.shorten_name(u'banners_banner_urls')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('banner', models.ForeignKey(orm[u'banners.banner'], null=False)),
            ('url', models.ForeignKey(orm[u'banners.url'], null=False))
        ))
        db.create_unique(m2m_table_name, ['banner_id', 'url_id'])

        # Adding model 'Log'
        db.create_table(u'banners_log', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='users', null=True, to=orm['account.MyUser'])),
        ...
        db.send_create_signal(u'banners', ['Log'])

        # Adding M2M table for field urls on 'Log'
        m2m_table_name = db.shorten_name(u'banners_log_urls')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('log', models.ForeignKey(orm[u'banners.log'], null=False)),
            ('url', models.ForeignKey(orm[u'banners.url'], null=False))
        ))
        db.create_unique(m2m_table_name, ['log_id', 'url_id'])

        # Adding model 'LogStat'
        db.create_table(u'banners_logstat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'banners', ['LogStat'])

        # Adding M2M table for field urls on 'LogStat'
        m2m_table_name = db.shorten_name(u'banners_logstat_urls')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('logstat', models.ForeignKey(orm[u'banners.logstat'], null=False)),
            ('url', models.ForeignKey(orm[u'banners.url'], null=False))
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'URL'
        db.delete_table(u'banners_url')

        # Deleting model 'BannerGroup'
        db.delete_table(u'banners_bannergroup')

        # Deleting model 'Banner'
        db.delete_table(u'banners_banner')

        # Removing M2M table for field urls on 'Banner'
        db.delete_table(db.shorten_name(u'banners_banner_urls'))

        # Deleting model 'Log'
        db.delete_table(u'banners_log')

        # Removing M2M table for field urls on 'Log'
        db.delete_table(db.shorten_name(u'banners_log_urls'))

        # Deleting model 'LogStat'
        db.delete_table(u'banners_logstat')

        # Removing M2M table for field urls on 'LogStat'
        db.delete_table(db.shorten_name(u'banners_logstat_urls'))
    ...
    models = {
        ...
        u'banners.banner': {
            ...
            'onlyauth': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'banners.log': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'to': u"orm['account.MyUser']"}),
