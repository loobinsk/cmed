...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventAccess'
        db.create_table(u'account_eventaccess', (
        ...
        db.send_create_signal(u'account', ['EventAccess'])

        # Adding index on 'EventAccess', fields ['event_type', 'user']
        db.create_index(u'account_eventaccess', ['event_type', 'user_id'])

        # Adding index on 'EventAccess', fields ['event_type', 'user', 'time']
        db.create_index(u'account_eventaccess', ['event_type', 'user_id', 'time'])


    def backwards(self, orm):
        # Removing index on 'EventAccess', fields ['event_type', 'user', 'time']
        db.delete_index(u'account_eventaccess', ['event_type', 'user_id', 'time'])

        # Removing index on 'EventAccess', fields ['event_type', 'user']
        db.delete_index(u'account_eventaccess', ['event_type', 'user_id'])

        # Deleting model 'EventAccess'
        db.delete_table(u'account_eventaccess')
