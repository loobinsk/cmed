...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timer.post'
        db.clear_table(u'account_timer')
        db.alter_column(u'account_timer', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medtus.Translation']))

    def backwards(self, orm):

        # Changing field 'Timer.post'
        db.alter_column(u'account_timer', 'post_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.Posts']))
