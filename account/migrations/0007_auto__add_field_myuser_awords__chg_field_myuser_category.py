...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyUser.awords'
        db.add_column(u'account_myuser', 'awords',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['account.Aword'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'MyUser.category'
        db.alter_column(u'account_myuser', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Category'], null=True))

    def backwards(self, orm):
        # Deleting field 'MyUser.awords'
        db.delete_column(u'account_myuser', 'awords_id')


        # User chose to not deal with backwards NULL issues for 'MyUser.category'
        raise RuntimeError("Cannot reverse this migration. 'MyUser.category' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'MyUser.category'
        db.alter_column(u'account_myuser', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.Category']))
    ...
    models = {
        ...
        u'account.myuser': {
            ...
            'awords': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['account.Aword']", 'null': 'True', 'blank': 'True'}),
            'birthday': ('django.db.models.fields.DateField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['account.Category']", 'null': 'True', 'blank': 'True'}),
