...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MyUser', fields ['id', 'town']
        db.create_index(u'account_myuser', ['id', 'town'])


    def backwards(self, orm):
        # Removing index on 'MyUser', fields ['id', 'town']
        db.delete_index(u'account_myuser', ['id', 'town'])
    ...
    models = {
        ...
        u'account.myuser': {
            ...
            'Meta': {'object_name': 'MyUser', 'index_together': "[['id', 'town']]"},
