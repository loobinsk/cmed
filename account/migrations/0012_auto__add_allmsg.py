...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AllMsg'
        db.create_table(u'account_allmsg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='receiver', to=orm['account.MyUser'])),
            ('msgs', self.gf('tinymce.models.HTMLField')(default='', blank=True)),
            ('datetime', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('unreaded', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'account', ['AllMsg'])


    def backwards(self, orm):
        # Deleting model 'AllMsg'
        db.delete_table(u'account_allmsg')
    ...
    models = {
        ...
        u'account.allmsg': {
            'Meta': {'object_name': 'AllMsg'},
            'datetime': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'msgs': ('tinymce.models.HTMLField', [], {'default': "''", 'blank': 'True'}),
            'unreaded': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'receiver'", 'to': u"orm['account.MyUser']"})
        },
        u'account.aword': {
