...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Timer.test'
        db.add_column(u'account_timer', 'test',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quiz.Quiz'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Timer.test'
        db.delete_column(u'account_timer', 'test_id')
    ...
    models = {
        ...
        u'account.timer': {
            ...
            'test': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quiz.Quiz']", 'null': 'True', 'blank': 'True'}),
