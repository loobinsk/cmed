...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'MyUser.graduate' to match new field type.
        db.rename_column(u'account_myuser', 'graduate', 'graduate_id')
        # Changing field 'MyUser.graduate'
        db.alter_column(u'account_myuser', 'graduate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['library.Graduate'], null=True))
        # Adding index on 'MyUser', fields ['graduate']
        db.create_index(u'account_myuser', ['graduate_id'])


    def backwards(self, orm):
        # Removing index on 'MyUser', fields ['graduate']
        db.delete_index(u'account_myuser', ['graduate_id'])


        # Renaming column for 'MyUser.graduate' to match new field type.
        db.rename_column(u'account_myuser', 'graduate_id', 'graduate')
        # Changing field 'MyUser.graduate'
        db.alter_column(u'account_myuser', 'graduate', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
