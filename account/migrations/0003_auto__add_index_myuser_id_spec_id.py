...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MyUser', fields ['id', 'spec_id']
        db.create_index(u'account_myuser', ['id', 'spec_id'])


    def backwards(self, orm):
        # Removing index on 'MyUser', fields ['id', 'spec_id']
        db.delete_index(u'account_myuser', ['id', 'spec_id'])
