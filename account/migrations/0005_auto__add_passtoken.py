...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PassToken'
        db.create_table(u'account_passtoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.MyUser'], unique=True,
                                                                           on_delete=models.DO_NOTHING,
                                                                           max_length=10)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal(u'account', ['PassToken'])
        db.execute("ALTER TABLE `account_passtoken` ENGINE=`MyISAM`;")
        db.execute("ALTER TABLE `account_passtoken` CHANGE COLUMN `user_id` `user_id` int(10) NOT NULL;")


    def backwards(self, orm):
        # Deleting model 'PassToken'
        db.delete_table(u'account_passtoken')
